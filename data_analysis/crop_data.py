# this script systematically determines the t_ranges indices in which to crop the data
# by looking at the variance of the u velocity and determing a threshold to compare
# the values to
